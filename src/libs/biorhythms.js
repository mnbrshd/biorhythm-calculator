...
const calculateBiorhythms = (birthDate, targetDate) => {
    return {
...
const calculateBiorhythmSeries = (birthDate, centralDate, range) =>{
    const series = [];
...
export {calculateBiorhythms, calculateBiorhythmSeries};